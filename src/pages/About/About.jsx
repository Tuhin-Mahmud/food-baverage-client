        ...
        <div className=" my-10">
            <div className=' flex flex-col lg:flex-row gap-3'>
                ...
                <div className="lg:w-1/2 p-4">
                    ...
                    <h1 className='text-4xl md:text-6xl font-serif font-medium my-3'>Delicia&apos;s about fresh <br /> flavorful dining</h1>
                    ...
                    {/*  */}
                    <div className='flex items-center   flex-col lg:flex-row gap-5 my-5'>
                        <div className='flex  items-center  justify-center bg-gray-300 p-2 w-2/5 rounded-lg'>
                    ...
                    <div className='flex items-center justify-center md:justify-start'>
                        <h1 className='bg-orange-500 w-1/4 p-1 md:p-3 rounded-lg text-white text-center text-lg md:text-xl hover:bg-black duration-500 transition  '>Read More..</h1>
                    </div>
