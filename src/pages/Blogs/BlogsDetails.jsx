                    ...
                    <div className="col-span-4 ">
                        <div>
                            ...
                            <div>
                                ...
                                {/* ------- */}
                                <div className="bg-black p-5 md:px-32 text-center text-white md:h-[200px] flex items-center hover:bg-orange-500 duration-500 transition ">
                                ...
                                <div className="bg-gray-300 py-12 border-l-4 border-orange-500 flex items-center relative px-5">
                                    <p><FaQuoteLeft className=" bottom-5 md:text-4xl text-slate-400 flex absolute right-5" /></p>
